...
__We have found that the public OAST servers that ZAP has preconfigured appear to be overloaded right now, which means they may not respond to requests generated by the payloads or requests from ZAP.__

__For now we recommend that you set up your own OAST server to test for this vulnerability.__
