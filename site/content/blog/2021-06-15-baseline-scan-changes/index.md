...
{{< terminal "docker run owasp/zap2docker-weekly zap-baseline.py -t https://www.example.bad" >}}2021-06-10 11:08:44,764 Could not find custom hooks file at /home/zap/.zap_hooks.py 
...
```
docker run -v $(pwd):/zap/wrk/:rw -t owasp/zap2docker-weekly zap-baseline.py -t https://www.example.com -j
``` 
