...
_ The victim has an active session on the target site.
_ The victim is authenticated via HTTP auth on the target site. \* The victim is on the same local network as the target site.
