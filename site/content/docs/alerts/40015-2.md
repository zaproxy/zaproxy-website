...
other: "parameter [param] on [GET] [https://example.com/] may be vulnerable to LDAP injection, by using the logically equivalent expression [test)(objectClass=*], and FALSE expression [randomvalue]."
cwe: 90
wasc: 29
techtags: 
  - Protocol.LDAP
