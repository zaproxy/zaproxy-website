...
other: "The query time is controllable using parameter value [test / (DBMS_SESSION.SLEEP(5)) ], which caused the request to take [5,000] milliseconds, when the original unmodified query with value [test] took [100] milliseconds."
cwe: 89
wasc: 19
techtags: 
  - Db.Oracle
