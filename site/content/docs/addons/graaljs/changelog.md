...
title: GraalVM JavaScript Add-on Changelog
type: changelog
weight: 1
cascade:
  addon:
...
[0.14.0]: https://github.com/zaproxy/zap-extensions/releases/graaljs-v0.14.0
[0.13.0]: https://github.com/zaproxy/zap-extensions/releases/graaljs-v0.13.0
