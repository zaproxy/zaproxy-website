...
title: DOM XSS Active scanner rule Add-on SBOM
type: sbom
weight: 1
aliases:
- /docs/sbom/domxss/
...
sbom:
  format: CycloneDX
  downloadUrl: https://github.com/zaproxy/zap-extensions/releases/download/domxss-v24/bom.json
  components:
