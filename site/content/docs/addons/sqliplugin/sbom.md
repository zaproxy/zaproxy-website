...
title: Advanced SQLInjection Scanner Add-on SBOM
type: sbom
weight: 1
aliases:
- /docs/sbom/sqliplugin/
cascade:
  addon:
    id: sqliplugin
    version: '17'
sbom:
  format: CycloneDX
  downloadUrl: https://github.com/zaproxy/zap-extensions/releases/download/sqliplugin-v17/bom.json
  components:
  ...
  - name: jdom
    version: 2.0.2
    licenses: Similar to Apache License but with the acknowledgment clause removed
  - name: jericho-html
    version: '3.4'
