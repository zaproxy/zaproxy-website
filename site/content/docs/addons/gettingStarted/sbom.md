...
title: Getting Started with ZAP Guide Add-on SBOM
type: sbom
weight: 1
aliases:
- /docs/sbom/gettingStarted/
cascade:
  addon:
    id: gettingStarted
    version: '20'
sbom:
  format: CycloneDX
  downloadUrl: https://github.com/zaproxy/zap-extensions/releases/download/gettingStarted-v20/bom.json
  components:
  - name: asm
    version: '9.7'
