...
title: Custom Payloads Add-on SBOM
type: sbom
weight: 1
aliases:
- /docs/sbom/custompayloads/
cascade:
  addon:
    id: custompayloads
    version: 0.16.0
sbom:
  format: CycloneDX
  downloadUrl: https://github.com/zaproxy/zap-extensions/releases/download/custompayloads-v0.16.0/bom.json
  components:
