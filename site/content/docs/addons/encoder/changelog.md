...
title: Encoder Add-on Changelog
type: changelog
weight: 1
cascade:
  addon:
...
[1.9.0]: https://github.com/zaproxy/zap-extensions/releases/encoder-v1.9.0
[1.8.0]: https://github.com/zaproxy/zap-extensions/releases/encoder-v1.8.0
