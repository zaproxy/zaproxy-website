...
```
  - type: activeScan                   # The active scanner - this actively attacks the target so should only be used with permission
    parameters:
      ...
      defaultStrength:                 # String: The default Attack Strength for the specified scan policy.
      defaultThreshold:                # String: The default Alert Threshold for the specified scan policy.
